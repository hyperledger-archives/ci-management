...
rm -rf /etc/Pegasus/*.cnf /etc/Pegasus/*.crt /etc/Pegasus/*.csr \
       ...
       /var/log/debug* /var/log/dmesg* /var/log/exim4/* /var/log/faillog* \
       /var/log/gdm/* /var/log/glusterfs/*glusterd.vol.log \
       ...
       /var/log/secure* /var/log/setroubleshoot/*.log /var/log/spooler* \
